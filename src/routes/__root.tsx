...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "أذان" },
      { name: "theme-color", content: "#0f172a" },
      { name: "mobile-web-app-capable", content: "yes" },
      { title: "أذان — مواقيت الصلاة" },
      { name: "description", content: "تطبيق أذان لعرض مواقيت الصلاة في دول الخليج بدقة" },
      { property: "og:title", content: "أذان — مواقيت الصلاة" },
      { property: "og:description", content: "مواقيت الصلاة في دول الخليج" },
